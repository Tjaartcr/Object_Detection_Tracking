...
##            print(f"Center_Point_List_Current: {Center_Point_List_Current}")

##            predicted = kf.predict(Cx, Cy)
##            cv2.circle(frame, (predicted[0], predicted[1]), 50, (255, 0, 0), 4)
##
...
##                    predicted = kf.predict(pt[0], pt2[1])
##                    cv2.circle(frame, (predicted[0], predicted[1]), 20, (255, 0, 0), 4)
...
##                    print("Distance : ", distance)
        ...
        for object_id, pt in tracking_objects.items():
            ...
            print(f"object id: {My_New_String}")

            print(f"Points: {pt[0], pt[1]}")


            My_X_act = pt[0]
            My_Y_act = pt[1]
            
            Act_points =  (pt[0], pt[1])  
            print(f"Act_points: {Act_points}")


            predicted = kf.predict(pt[0], pt[1])

            predicted = kf.predict(My_X_act, My_Y_act)
